          ...
          <div ref={contentRef} className="space-y-8">
            <div className="space-y-4">
              <p className="text-xl text-muted-foreground leading-relaxed font-light">
                ...
                With 2+ years of experience in modern web technologies, I
                specialize in building scalable, high-performance applications
                that solve real-world problems.
              </p>

              <p className="text-lg text-muted-foreground leading-relaxed">
                My approach combines clean code architecture with thoughtful UX
                design. I'm proficient in React and Next.js for frontend
                development, with solid backend expertise in Django, Node.js,
                and database management. I believe in writing maintainable code
                and creating intuitive user experiences.
              </p>

              <p className="text-lg text-muted-foreground leading-relaxed">
                Beyond coding, I'm passionate about exploring emerging
                technologies, contributing to open-source projects, and sharing
                knowledge with the developer community. When I'm not coding,
                you'll find me exploring design trends, experimenting with new
                frameworks, or working on innovative side projects.
              </p>
            </div>

            <div className="space-y-3 pt-4">
              <h3 className="text-sm uppercase tracking-widest font-semibold text-primary">
                Technical Skills
              </h3>
